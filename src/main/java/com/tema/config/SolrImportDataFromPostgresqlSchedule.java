...
public class SolrImportDataFromPostgresqlSchedule {
    ...
    private void configureTasks() {
        String uri =
                "http://localhost:8983/solr/new_core/dataimport?command=full-import&clean=%20true&commit=true&wt=json&indent=true&verbose=false&optimize=false&debug=false&id=1";
