...
public class SignupController {
	...
	@PostMapping
	public String signUp(@Valid @ModelAttribute("signupUser")SignUpForm signupUser
		...
		if(userMapper.getOneByEmail(signupUser.getEmail()) != null) {
	...
	public String verify(@ModelAttribute("signupUser")SignUpForm s
		...
		if (captcha.equals(s.getCaptcha())) {
			...
			String md5Passward =  DigestUtils.md5DigestAsHex(signupUser.getPassword().getBytes());
			user.setPassword(md5Passward);
			user.setBirth(signupUser.getBirth());
